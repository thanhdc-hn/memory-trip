...
const ADMIN_SECRET = process.env.VITE_SUPABASE_ADMIN_SECRET || process.env.ADMIN_SECRET || 'fallback-secret-for-dev'
...
export async function validateAdmin(event: any) {
