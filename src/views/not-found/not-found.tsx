    ...
    <div className="flex min-h-screen items-center justify-center bg-white p-4 dark:bg-[#0f1014]">
      <div className="w-full max-w-lg text-center">
        <div className="relative mb-4 h-50 sm:h-70">
          <div
            className="absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center text-[100px] font-black tracking-[-20px] text-[#222] uppercase sm:text-[150px] dark:text-white">
            4
            <span
        ...
        <button
          onClick={goHomePage}
          className="inline-block rounded-full bg-accent px-8 py-3 text-sm font-bold text-white uppercase transition-all hover:bg-[#932ee0] hover:shadow-lg active:scale-95"
        >
          Back to homepage
        </button>
      </div>
